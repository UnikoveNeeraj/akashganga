...
const PublishingEditor = () => {
  return (
    <DashboardLayout>
      ...
      <div>
        <h6 style={{ marginTop: "35px", fontWeight: "bold", color: "#404040" }}>For Review</h6>
      ...
      <RequestArticle
        requested_date={"12 May 2023"}
        due_date={"24 May 2023"}
        edition={"New"}
        title={"1914 translation by H. Rackham"}
        subtitle={"School of Public Health, Faculty of Medicine, University of Queensland, Goonellabah, Australia"}
        tagsOne={"Research Article"}
        description={"Public schools have several programs in place to mitigate the problem of food insecurity, including free breakfast and reduced lunch. Over the course of one school year to see how effective Call for papers: It gives me immense pleasure to announce that there.Over the course of one school year to see how effective Call for papers: It gives me immense..."}
        tagsTwo={"Akashganga Journal of Social Science"}
        tagsThree={"Anthropology"}
      />
...
const RequestArticle = ({ requested_date, due_date, edition, title, subtitle, tagsOne, description, tagsTwo, tagsThree }) => {
  return (
    <div className='research-article'>
      <div className='d-flex gap-2 justify-content-between'>
        <div className='d-flex gap-2'>
          <p>Requested On: {requested_date}</p>
          <span>|</span>
          <p>Due By: {due_date}</p>
        </div>
        <button className='px-2 btn-edition'>{edition}</button>
      </div>

      <p style={{ color: "#167092", fontWeight: "bold" }} className="default-mt">{title}</p>
      <p style={{ backgroundColor: "#EBF4F4", width: "130px", padding: "3px", borderRadius: "5px" }} className="default-mt">Research Article</p>
      <p className="default-mt">Public schools have several programs in place to mitigate the problem of food insecurity, including free breakfast and reduced lunch.<br></br>
        Over the course of one school year to see how effective Call for papers: It gives me immense pleasure to announce that there. Over<br></br>
        the course of one school year to see how effective Call for papers: It gives me immense pleasure to announce that there...
      </p>
      <hr />
